...
if(_servo_control_CONFIG_INCLUDED)
  # ensure to keep the found flag the same
  if(NOT DEFINED servo_control_FOUND)
    # explicitly set it to FALSE, otherwise CMake will set it to TRUE
    set(servo_control_FOUND FALSE)
  elseif(NOT servo_control_FOUND)
    # use separate condition to avoid uninitialized variable warning
    set(servo_control_FOUND FALSE)
  endif()
  return()
endif()
set(_servo_control_CONFIG_INCLUDED TRUE)
...
if(NOT "" STREQUAL "")
  set(_msg "Package 'servo_control' is deprecated")
  # append custom deprecation text if available
  if(NOT "" STREQUAL "TRUE")
    set(_msg "${_msg} ()")
  endif()
  # optionally quiet the deprecation message
  if(NOT ${servo_control_DEPRECATED_QUIET})
    message(DEPRECATION "${_msg}")
  endif()
endif()

# flag package as ament-based to distinguish it after being find_package()-ed
set(servo_control_FOUND_AMENT_PACKAGE TRUE)
...
foreach(_extra ${_extras})
  include("${servo_control_DIR}/${_extra}")
endforeach()
