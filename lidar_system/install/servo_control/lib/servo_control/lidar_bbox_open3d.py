#!/usr/bin/env python3
"""
Robust LiDAR 3D bounding box node (v3)
Optimized for human detection

Improvements:
- tighter clustering
- ground plane removal
- human size filtering
- rejects giant merged clusters
- rolling buffer for accumulated scans
"""
...
class LidarBBoxOpen3DV2(Node):
    ...
    def pc_callback(self, msg: PointCloud2):
        ...
        for cid in range(labels.max() + 1):
            ...
            mk.scale.y = float(depth)
            mk.scale.z = float(height)
